<div class="navbar navbar-expand-md navbar-light">
  <div class="container-xl">
    <a href="/" class="navbar-brand d-flex align-items-center">
      <span class="ms-2">Unitfed</span>
    </a>

    <div class="navbar-nav ms-auto">
      <div class="nav-item dropdown">
        <a href="#" class="nav-link d-flex align-items-center" data-bs-toggle="dropdown">
          <span class="avatar avatar-sm" style="background-color:#dee2e6;border-radius:6px;display:inline-block;width:28px;height:28px;"></span>
                      ...
                      <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                          <div class="dropdown-menu-column">
                            ...
                            <a class="dropdown-item active" href="./layout-fluid.html"> Fluid </a>
